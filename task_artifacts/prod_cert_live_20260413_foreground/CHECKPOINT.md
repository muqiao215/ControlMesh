...
- Live ductor binary loads the current repo code directly:
  - ductor_bot: /root/.ductor/analysis/ductor-src/ductor_bot/__init__.py
  - cli.service: /root/.ductor/analysis/ductor-src/ductor_bot/cli/service.py
  - service_logs: /root/.ductor/analysis/ductor-src/ductor_bot/infra/service_logs.py
  - service_linux: /root/.ductor/analysis/ductor-src/ductor_bot/infra/service_linux.py
