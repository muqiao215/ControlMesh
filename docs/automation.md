...
controlmesh automation systems:
...
- persisted in `~/.controlmesh/tasks.json`
- task folders in `~/.controlmesh/workspace/tasks/<task_id>/`
...
Cron jobs run in `~/.controlmesh/workspace/cron_tasks/<task_folder>/`.
