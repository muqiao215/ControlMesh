...
- macOS/Windows: file tail from `~/.controlmesh/logs/agent.log` (fallback newest `*.log`)
...
Centralised loading of user-defined API secrets from `~/.controlmesh/.env`.
