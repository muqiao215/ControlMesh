...
- Command menus: `/cm` opens Claude native commands, `/back` returns to ControlMesh commands, `/cm <controlmesh-command>` runs one ControlMesh command from the Claude menu
