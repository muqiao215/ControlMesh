...
Full rollout still needs the remaining provider/transport/store/topology owners, device-local
History adoption, reviewed SpecMesh closeout, user terminal workflow, package/default switch
