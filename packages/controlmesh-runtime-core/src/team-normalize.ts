...
export function text(value: unknown): unknown { return typeof value === "string" ? value.replace(strip, "") : value; }
export function optional(value: unknown): unknown { return value === undefined ? null : text(value); }
export function number(value: unknown, integer = false): unknown {
...
export function boolean(value: unknown): unknown {
...
export function entries(value: unknown, kind: "item" | "evidence" | "artifact"): unknown {
