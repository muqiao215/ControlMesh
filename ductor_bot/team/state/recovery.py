...
from ductor_bot.team.state.snapshot import TeamControlSnapshot, TeamControlSnapshotManager
...
class TeamControlSnapshotRecoveryAdvisor:
    ...
    def __init__(self, paths: DuctorPaths, *, state_root: Path | str | None = None) -> None:
