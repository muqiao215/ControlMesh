...
from ductor_bot.team.phases import initial_phase_state, transition_phase
...
class TeamOrchestrator:
    ...
    def transition(self, to_phase: str, *, reason: str | None = None):  # type: ignore[no-untyped-def]
