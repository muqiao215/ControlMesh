...
from ductor_bot.messenger.feishu.auth.auth_cards import build_auth_failed_card
...
from ductor_bot.messenger.feishu.auth.feishu_card_sender import FeishuCardHandle, FeishuCardSender
from ductor_bot.messenger.feishu.auth.token_store import FeishuTokenStore

if TYPE_CHECKING:
    from ductor_bot.messenger.feishu.bot import FeishuIncomingText
...
class FeishuCardAuthRunner:
    ...
    def __init__(  # noqa: PLR0913
        ...
        *,
        ...
        self._now_ms = now_ms
        self._token_store = FeishuTokenStore(config.ductor_home)
