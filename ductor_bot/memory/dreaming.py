...
from ductor_bot.memory.store import append_dream_entry, initialize_memory_v2
...
def _iter_daily_note_paths(paths: DuctorPaths) -> list[Path]:
...
def _append_sweep_log(paths: DuctorPaths, result: DreamingSweepResult) -> None:
