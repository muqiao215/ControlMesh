...
- Runtime cut 1 green now exposes `DuctorPaths.runtime_events_dir`.
- Runtime cut 1 green now provides a real `RuntimeEvent` schema and `RuntimeEventStore` append/read behavior under `~/.ductor/runtime-events/...`.
