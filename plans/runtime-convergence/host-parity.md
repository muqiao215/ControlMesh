...
| Explicit cancellation | runtime/host_jobs.py:cancel | Running-step cancellation now retains same-episode outcome and synchronizes cancelled job/step; queued-step and crash-window convergence remain | Atomic cancellation intent plus confirmed process outcome reflected in job/step; no success claim or repeated command |
