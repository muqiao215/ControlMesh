...
def orch_with_mock_cli(
    workspace: tuple[ControlMeshPaths, AgentConfig],
...
class TestCommandRouting:
    ...
    async def test_model_command_no_args_returns_selector(
        ...
        with patch(
            "controlmesh.orchestrator.commands.model_selector_start",
...
class TestSessionPersistence:
    async def test_sessions_survive_manager_recreation(
        self, workspace: tuple[ControlMeshPaths, AgentConfig]
    ) -> None:
        paths, config = workspace
    ...
    async def test_session_json_is_valid(self, workspace: tuple[ControlMeshPaths, AgentConfig]) -> None:
        paths, config = workspace
