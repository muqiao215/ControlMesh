...
from ductor_bot.memory.promotion import parse_promotion_candidates
...
- [preference score=0.90] Prefer OpenClaw-style split memory, but adapted for Ductor.
"""
...
## Promotion Candidates
- [decision] Keep canonical authority file-backed and human-readable.
- [preference score=0.70] Prefer OpenClaw-style split memory, but adapted for Ductor.
""",
        encoding="utf-8",
    )
