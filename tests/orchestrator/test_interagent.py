...
@pytest.fixture
def orch_ia(workspace: tuple[ControlMeshPaths, AgentConfig]) -> Orchestrator:
...
class TestInteragentChatId:
    ...
    def test_returns_zero_when_no_users(self, workspace: tuple[ControlMeshPaths, AgentConfig]) -> None:
        paths, config = workspace
