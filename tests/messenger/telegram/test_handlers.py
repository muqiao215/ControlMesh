...
class TestHandleAbort:
    ...
    async def test_abort_kills_processes_and_replies(self) -> None:
        from controlmesh.messenger.telegram.handlers import handle_abort
...
class TestHandleAbortAll:
    ...
    async def test_abort_all_kills_local_and_callback(self) -> None:
        from controlmesh.messenger.telegram.handlers import handle_abort_all
...
class TestHandleCommand:
    ...
    async def test_command_routes_to_orchestrator(self) -> None:
        from controlmesh.messenger.telegram.handlers import handle_command
...
class TestHandleNewSession:
    ...
    async def test_new_resets_session(self) -> None:
        from controlmesh.messenger.telegram.handlers import handle_new_session
...
class TestStripMention:
    ...
    def test_removes_mention(self) -> None:
        from controlmesh.messenger.telegram.handlers import strip_mention
...
class TestForumTopicPropagation:
    ...
    @patch("controlmesh.messenger.telegram.handlers.send_rich", new_callable=AsyncMock)
