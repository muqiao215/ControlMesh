...
class TestSequentialMiddleware:
    ...
    async def test_sequential_processing(self) -> None:
        from controlmesh.messenger.telegram.middleware import SequentialMiddleware
...
class TestIsQuickCommand:
    ...
    def test_is_quick_command(self, text: str, expected: bool) -> None:
        from controlmesh.messenger.telegram.middleware import is_quick_command
...
class TestQueueManagement:
    ...
    async def test_cancel_entry_marks_cancelled(self) -> None:
        from controlmesh.messenger.telegram.middleware import SequentialMiddleware, _QueueEntry
