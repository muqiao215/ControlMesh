...
class TestIsAbortTrigger:
    ...
    def test_english_abort_words(self, word: str) -> None:
        from controlmesh.messenger.telegram.abort import is_abort_trigger
...
class TestIsAbortMessage:
    ...
    def test_stop_command(self) -> None:
        from controlmesh.messenger.telegram.abort import is_abort_message
    ...
    def test_stop_command_with_bot_mention(self) -> None:
        ...
        assert is_abort_message("/stop@controlmesh") is True
...
class TestIsAbortAllTrigger:
    ...
    def test_abort_all_phrases(self, phrase: str) -> None:
        from controlmesh.messenger.telegram.abort import is_abort_all_trigger
...
class TestIsAbortAllMessage:
    ...
    def test_stop_all_command(self) -> None:
        from controlmesh.messenger.telegram.abort import is_abort_all_message
    ...
    def test_stop_all_command_with_bot_mention(self) -> None:
        ...
        assert is_abort_all_message("/stop_all@controlmesh") is True
...
class TestIsInterruptTrigger:
    ...
    def test_interrupt_words(self, word: str) -> None:
        from controlmesh.messenger.telegram.abort import is_interrupt_trigger
...
class TestIsInterruptMessage:
    ...
    def test_interrupt_command(self) -> None:
        from controlmesh.messenger.telegram.abort import is_interrupt_message
    ...
    def test_interrupt_command_with_bot_mention(self) -> None:
        ...
        assert is_interrupt_message("/interrupt@controlmesh") is True
