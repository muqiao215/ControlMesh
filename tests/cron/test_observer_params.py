...
from controlmesh.cron.execution import OneShotCommand
...
class TestResolveExecutionConfig:
    ...
    def test_resolve_execution_config_no_overrides(
        ...
        with patch("controlmesh.infra.base_task_observer.resolve_cli_config") as mock_resolve:
...
class TestExecuteJobWithOverrides:
    ...
    async def test_execute_job_with_model_override(
        ...
        with (
            ...
            patch("controlmesh.cron.execution.build_cmd") as mock_build,
            patch("controlmesh.infra.base_task_observer.resolve_cli_config") as mock_resolve,
