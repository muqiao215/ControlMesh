...
from ductor_bot.history import TranscriptStore, TranscriptTurn
...
def test_transcript_store_path_for_root_session(tmp_path: Path) -> None:
    ...
    assert store.path_for(SessionKey.telegram(123)) == tmp_path / ".ductor" / "transcripts" / "tg" / "123" / "root.jsonl"
