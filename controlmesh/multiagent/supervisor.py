...
class AgentSupervisor:
    ...
    def __init__(self, main_config: AgentConfig) -> None:
        ...
        self._main_paths = resolve_paths(controlmesh_home=main_config.controlmesh_home)
        self._agents_path = self._main_paths.controlmesh_home / "agents.json"
    ...
    async def _start_sub_agent(self, sub_cfg: SubAgentConfig) -> None:
        ...
        agent_home = self._main_paths.controlmesh_home / "agents" / name
