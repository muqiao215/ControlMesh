...
from controlmesh.background import BackgroundObserver, BackgroundResult
...
from controlmesh.cli.gemini_cache_observer import GeminiCacheObserver
from controlmesh.cli.service import CLIService
from controlmesh.config import AgentConfig, get_gemini_models
from controlmesh.config_reload import ConfigReloader
from controlmesh.cron.manager import CronManager
from controlmesh.cron.observer import CronObserver
from controlmesh.heartbeat import HeartbeatObserver
from controlmesh.webhook.manager import WebhookManager
from controlmesh.webhook.models import WebhookResult
from controlmesh.webhook.observer import WebhookObserver
from controlmesh.workspace.init import watch_rule_files
from controlmesh.workspace.paths import ControlMeshPaths
from controlmesh.workspace.skill_sync import watch_skill_sync
...
class ObserverManager:
    ...
    def __init__(self, config: AgentConfig, paths: ControlMeshPaths) -> None:
        self._config = config
        self._paths = paths
    ...
    def wire_to_bus(
        ...
        *,
        ...
        """
        from controlmesh.bus.adapters import (
