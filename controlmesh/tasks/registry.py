    ...
    def create(
        ...
        *tasks_dir* overrides the default tasks directory (for per-agent isolation).
        ...
        entry = TaskEntry(
            ...
            auto_micro_commit=submit.auto_micro_commit,
            auto_micro_commit_push=submit.auto_micro_commit_push,
            micro_commit_message=submit.micro_commit_message,
...
def _seed_task_folder(
    ...
    rules_content = build_task_agent_rules(taskmemory)
